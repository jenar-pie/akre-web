      ...
      <div className="max-w-[1280px] mx-auto px-3 sm:px-5 lg:px-8">
        ...
        <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-3 mb-5">
          <div className="max-w-xl">
            <h2 className="text-xl sm:text-2xl font-bold text-primary">Fasilitas Kami</h2>
            <p className="text-sm sm:text-base text-gray-600 mt-1 leading-relaxed">
              Kami menghadirkan fasilitas kesehatan lengkap dengan standar terbaik dalam nuansa islami, insyaAllah menjadi ikhtiar menuju kesembuhan.
            </p>
          </div>
          <Link
          ...
          >
            <span>Lihat fasilitas lainnya</span>
