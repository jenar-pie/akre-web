...
export default function JanjiTemuPage() {
  return (
    <div className="max-w-[1240px] mx-auto px-4 py-16 text-center min-h-[50vh] flex flex-col items-center justify-center">
      ...
      <h1 className="text-3xl font-bold text-primary mb-2">Pendaftaran Janji Temu Dokter</h1>
      <p className="text-gray-600 max-w-md mb-6">
        Halaman reservasi dan pemesanan janji temu spesialis RS Ridhoka Salma.
      </p>
      <Link
        href="/"
