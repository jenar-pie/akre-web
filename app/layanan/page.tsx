...
export default function LayananPage() {
  return (
    <div className="max-w-[1240px] mx-auto px-4 py-16 text-center min-h-[50vh] flex flex-col items-center justify-center">
      ...
      <h1 className="text-3xl font-bold text-primary mb-2">Layanan RS Ridhoka Salma</h1>
      <p className="text-gray-600 max-w-md mb-6">
        Daftar layanan medis unggulan, rawat jalan, rawat inap, dan pemeriksaan kesehatan.
      </p>
      <Link
        href="/"
