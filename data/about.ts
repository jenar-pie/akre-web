...
export const strukturOrganisasiData = {
  ...
  tabs: [
    ...
    { id: "pengawas", label: "Dewan Pengawas & DPS" },
    { id: "direksi", label: "Direksi & Pimpinan" },
    { id: "komite", label: "Komite Medis & Syariah" },
    { id: "manajemen", label: "Manajer & Kepala Divisi" },
  ],
  members: [
    {
      name: "Dr. KH. M. Anwar Syahid, M.Ag",
    ...
    {
      name: "Ustadz H. Ahmad Fauzi, Lc., M.E.Sy",
    ...
    },
    {
      ...
      role: "Wakil Direktur Pelayanan Medis & Keperawatan",
      title: "Direksi Medis",
      category: "direksi",
    ...
    {
      name: "H. Bambang Sutejo, S.E., M.M.",
      role: "Wakil Direktur Umum, SDM & Keuangan",
    ...
    {
      name: "Ns. Maryati, S.Kep., M.Kep",
      role: "Ketua Komite Keperawatan",
      title: "Komite Rumah Sakit",
      category: "komite",
    ...
    {
      name: "dr. Nurul Hidayah, Sp.PK",
      role: "Ketua Komite Mutu & Keselamatan Pasien (PMKP)",
      title: "Komite Rumah Sakit",
      category: "komite",
    ...
    {
      name: "H. Ahmad Zaki, S.Sy., C.Sy",
      role: "Ketua Komite Syariah RS",
      title: "Komite Rumah Sakit",
      category: "komite",
    ...
    {
      name: "dr. Rizki Pratama, Sp.A",
      role: "Ketua Komite Pencegahan & Pengendalian Infeksi (PPI)",
      title: "Komite Rumah Sakit",
      category: "komite",
      division: "Komite PPI",
    ...
    {
      name: "apt. Dewi Kartika, S.Farm",
      role: "Manajer Pelayanan Penunjang Medis & Farmasi",
    ...
    {
      name: "Supriyadi, S.Kom",
      role: "Manajer Teknologi Informasi & SIMRS",
      title: "Manajemen Rumah Sakit",
      category: "manajemen",
    ...
    {
      name: "Rina Kusuma Wardhani, S.E.",
      role: "Manajer Humas, Pemasaran & Kerjasama Asuransi",
      title: "Manajemen Rumah Sakit",
      category: "manajemen",
