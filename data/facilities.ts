...
export const categorizedFacilities = [
    ...
    items: [
      {
        ...
        image: "/assets/fasilitas/igd3.png",
      ...
      },
      {
        ...
        title: "ICU (Intensive Care Unit)",
        category: "Gawat Darurat & Perawatan Kritis",
        image: "/assets/fasilitas/icu2.png",
      ...
      },
      {
        ...
        category: "Gawat Darurat & Perawatan Kritis",
        image: "/assets/fasilitas/nicu-picu2.png",
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        category: "Layanan Rawat Jalan & Bedah",
        image: "/assets/fasilitas/anak1.png",
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        category: "Penunjang Medis & Diagnostik",
        image: "/assets/fasilitas/igd1.png",
      ...
      },
      {
        ...
        category: "Penunjang Medis & Diagnostik",
        image: "/assets/fasilitas/igd2.png",
  ...
  },
  {
    ...
    description: "Fasilitas penunjang kenyamanan keluarga pasien, kemudahan layanan, dan pemenuhan kebutuhan ibadah.",
    items: [
      {
        id: "musholla",
        ...
        badge: "Bersih & Sejuk",
        description: "Tersedia masjid dan sarana musholla yang bersih, sejuk ber-AC, serta perlengkapan shalat higienis bagi keluarga pasien dan pengunjung.",
        features: ["Tempat Wudhu Bersih & Terpisah Pria/Wanita", "Jadwal Shalat Berjamaah & Kajian Rutin", "Penyediaan Al-Qur'an & Buku Dzikir Pagi Petang"],
        iconName: "Building2",
      },
      {
        id: "ambulan",
        title: "Armada Ambulans 24 Jam",
        category: "Fasilitas Umum & Syariah",
        image: "/assets/fasilitas/ambulan.png",
        badge: "Siaga 24 Jam",
        description: "Armada ambulans siaga 24 jam dengan fasilitas medis lengkap dan tim paramedis terlatih untuk penjemputan darurat maupun rujukan.",
        features: ["Siaga 24 Jam Tanggap Cepat", "Peralatan Bantuan Hidup Dasar (BHD)", "Layanan Antar-Jemput & Rujukan Pasien"],
        iconName: "Car",
      },
      {
        id: "antar-obat",
        title: "Layanan Antar Obat (Delivery)",
        category: "Fasilitas Umum & Syariah",
        image: "/assets/fasilitas/antar-obat.png",
        badge: "Praktis & Cepat",
        description: "Layanan pengantaran obat langsung ke rumah pasien rawat jalan sehingga pasien dan keluarga tidak perlu menunggu lama mengantre di farmasi.",
        features: ["Pengantaran Obat Cepat & Aman", "Edukasi Aturan Pakai Obat Terlampir", "Jangkauan Wilayah Cikarang & Sekitarnya"],
        iconName: "Truck",
      },
      {
        id: "atm",
        title: "ATM BSI & Vending Machine",
        category: "Fasilitas Umum & Syariah",
        image: "/assets/fasilitas/atm-bsi-vending-machine.png",
        badge: "24 Jam Non-Stop",
        description: "Fasilitas penarikan tunai ATM BSI (Bank Syariah Indonesia) serta Vending Machine minuman & snack JumpStart otomatis 24 jam untuk kenyamanan pengunjung di lobi rumah sakit.",
        features: ["Mesin ATM BSI (Bank Syariah Indonesia)", "Vending Machine Minuman & Snack 24 Jam", "Akses Mudah & Nyaman di Lobi Utama RS"],
        iconName: "CreditCard",
      },
      {
        id: "haus",
        title: "Haus! Store (F&B Corner)",
        category: "Fasilitas Umum & Syariah",
        image: "/assets/fasilitas/haus.png",
        badge: "Minuman & Snack",
        description: "Gerai resmi Haus! di area rumah sakit yang menyediakan berbagai pilihan minuman segar kekinian, roti, dan aneka camilan lezat.",
        features: ["Pilihan Menu Minuman Segar & Manis", "Harga Terjangkau & Tempat Bersih", "Lokasi Strategis Mudah Dijangkau Pengunjung"],
        iconName: "Coffee",
      },
      {
        id: "homecare",
        title: "Layanan Homecare Medis",
        category: "Fasilitas Umum & Syariah",
        image: "/assets/fasilitas/homecare.png",
        badge: "Layanan ke Rumah",
        description: "Pelayanan kunjungan dokter dan perawat ke rumah pasien untuk perawatan luka pasca operasi, fisioterapi, dan pendampingan lansia.",
        features: ["Kunjungan Dokter & Nakes Profesional", "Perawatan Luka Pasca Operasi & DM", "Pendampingan Pasien Geriatri / Lansia"],
        iconName: "HeartHandshake",
      },
      {
        id: "kantin",
        title: "Kantin & Pujasera Halal Sehat",
        category: "Fasilitas Umum & Syariah",
        image: "/assets/fasilitas/kantin.png",
        badge: "Halal & Higienis",
        description: "Kantin rumah sakit yang menyajikan beragam pilihan makanan dan minuman sehat, bergizi, bersertifikat halal, dan terjamin higienis.",
        features: ["Menu Makanan Halal & Bernutrisi", "Area Makan Bersih, Rapi & Sejuk", "Pilihan Makanan Berat, Snack & Minuman"],
        iconName: "Utensils",
      },
      {
        id: "media-dakwah",
        title: "Media Dakwah & Audio Syariah",
        category: "Fasilitas Umum & Syariah",
        image: "/assets/fasilitas/media-dakwah.png",
        badge: "Edukasi Islami",
        description: "Sarana penyiaran tausiyah, murottal Al-Qur'an harian, adzan berkala, dan panduan ibadah bagi orang sakit di seluruh penjuru rumah sakit.",
        features: ["Kumandang Adzan & Murottal Merdu", "Edukasi Tuntunan Ibadah Orang Sakit", "Bimbingan Doa & Konseling Rohani Syariah"],
        iconName: "Tv",
      },
      {
        id: "parkir",
        title: "Area Parkir Luas & Teratur",
        category: "Fasilitas Umum & Syariah",
        image: "/assets/fasilitas/parkir.png",
        badge: "Aman & Luas",
        description: "Area parkir mobil dan motor yang luas, teratur, dilengkapi sistem gerbang karcis otomatis, rambu jelas, dan penerangan yang baik.",
        features: ["Kapasitas Parkir Mobil & Motor Memadai", "Jalur Khusus Ambulans & Drop-off Pasien", "Pengawasan Petugas & CCTV 24 Jam"],
        iconName: "ShieldCheck",
      },
      {
        id: "perpustakaan",
        title: "Pojok Baca & Perpustakaan Islami",
        category: "Fasilitas Umum & Syariah",
        image: "/assets/fasilitas/perpustakaan.png",
        badge: "Literasi Sehat",
        description: "Pojok baca dengan koleksi buku kesehatan Islami, fiqih medis, Al-Qur'an terjemahan, dan majalah edukatif untuk mengisi waktu tunggu.",
        features: ["Koleksi Buku Fiqih Medis, Doa & Kesehatan", "Tempat Duduk Tenang & Nyaman", "Terbuka Bebas untuk Semua Pengunjung"],
        iconName: "BookOpen",
      },
      {
        id: "playground",
        ...
        category: "Fasilitas Umum & Syariah",
        image: "/assets/fasilitas/playground.png",
        badge: "Ramah Anak",
        description: "Taman bermain anak yang aman, bersih, dan menyenangkan guna meredakan rasa cemas dan takut si kecil saat berada di lingkungan rumah sakit.",
        features: ["Mainan Edukatif & Aman (Bebas Sudut Tajam)", "Lantai Karpet Lembut & Bersih", "Menciptakan Suasana Ceria Bagi Anak"],
        iconName: "Baby",
      },
      {
        id: "security",
        title: "Pos Satpam & Keamanan 24 Jam",
        category: "Fasilitas Umum & Syariah",
        image: "/assets/fasilitas/security.png",
        badge: "Keamanan 24 Jam",
        description: "Sistem keamanan terpadu dengan petugas satpam yang ramah dan siap siaga 24 jam serta monitoring CCTV di seluruh area publik rumah sakit.",
        features: ["Petugas Satpam Siaga, Sopan & Sigap", "Monitoring CCTV 24 Jam Non-Stop", "Bantuan Kursi Roda & Pengantaran Pasien"],
        iconName: "ShieldCheck",
      },
    ],
  },
